...
`}
            ...
            <div className="text-gray-700">
                ...
                <ul className="list-disc pl-8 ">
                    ...
                    <li className="pl-2"><span className="font-bold">ARC</span> exhibition, Budapest, Family trauma tree
                    </li>
                    <li className="pl-2">Memorial exhibition for Ervin Lázár, Kisszékely</li>
                    <li className="pl-2"><span className="font-bold">Térkép bárhova</span> (Map to anywhere) anthology,
                        Két Hold Kiadó
                    </li>
                ...
                <ul className="list-disc pl-8 ">
                    ...
                    <li className="pl-2"><span className="font-bold">TRAKTA</span> illustration exhibition, 3rd place
                        selected by jury
                    </li>
                    <li className="pl-2"><span className="font-bold">3rd Budapest Illustration Festival</span>: Children
                    ...
                    <li className="pl-2">Istanbul <span className="font-bold">Borderless Artbook Festival</span></li>
                    <li className="pl-2"><span className="font-bold">2023: Ukmukfukk Zine Festival, Budapest</span></li>
                </ul>

                <p className="font-semibold mt-4">2021:</p>
                <ul className="list-disc pl-8 ">
                    <li className="pl-2"><span className="font-bold">2nd Budapest Illustration Festival</span>: Silent
